...
This tells us immediately that the server is a soft target. The outdated software means there are likely many known exploits available, and patching has clearly been neglected.
...
> 📸 **Screenshot:** Nikto scan output showing vulnerabilities
...
**There area plethora of other vulnerabilities**

There are quite a lot more vulnerabiliites, but the first three were the biggest. 
...
| Last 5 | loopback, reason, parsed, conf, changing |
...
**3. Remove or restrict access to non-public directories**
...
**4. Implement rate limiting and blocking for scanning tools**
