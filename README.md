...
1. **A 5 virtual machine home lab** built on an older laptop running as a healdless server, managed remotely from my main daily driver. The lan mirrors a penetration testing environment with an isolated network, culnerable targets and defensive monitoring. 
